...
const DEFAULT_DICTIONARY = [
  ...
  },
  {
    ...
    tags: [
      ...
      { name: "mission.nombre_jeh", desc: "Nombre de JEH de l'intervenant", example: "2" },
      { name: "mission.montant_remuneration", desc: "Rétribution brute de l'intervenant pour tous ses JEH (| lettres pour l'écrire en toutes lettres)", example: "311" },
      { name: "mission.remuneration_par_jeh", desc: "Rétribution brute par JEH (| decimales:2 → 155,50)", example: "155.5" },
      { name: "mission.nb_intervenants", desc: "Nombre d'intervenants sur la mission", example: "26" },
