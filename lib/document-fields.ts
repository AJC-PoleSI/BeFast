...
export const DOCUMENT_FIELDS: FieldDef[] = [
  ...
  { placeholder: "mission.nb_jours", label: "Nombre de jours (ancien modèle — préférer mission.nombre_jeh)", source: "missions.nb_jours" },
  { placeholder: "mission.taux_jour", label: "Tarif par JEH (ancien modèle, missions issues d'une proposition)", source: "missions.taux_jour" },
  ...
  // Barème PAR intervenant (cf. lib/missions/remuneration.ts) : 2 JEH pour 311 €.
  { placeholder: "mission.nombre_jeh", label: "Nombre de JEH de l'intervenant", source: "missions.nb_jeh (repli : nb_jours)", example: "2" },
  { placeholder: "mission.montant_remuneration", label: "Rétribution brute de l'intervenant pour l'ensemble de ses JEH", source: "missions.remuneration (repli : JEH × taux_jour)", example: "311" },
  { placeholder: "mission.remuneration_par_jeh", label: "Rétribution brute par JEH (rétribution ÷ nombre de JEH)", source: "calculé", example: "155.5" },
  { placeholder: "mission.nb_intervenants", label: "Nombre d'intervenants sur la mission", source: "missions.nb_intervenants", example: "26" },
