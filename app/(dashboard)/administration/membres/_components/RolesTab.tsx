...
function DeleteModal({ role, onConfirm, onCancel, loading }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={onCancel}>
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6 border border-red-100 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="mb-4 flex items-center justify-between gap-4">
        <p className="text-sm text-zinc-500">
          Créez les rôles et configurez leurs permissions — l&apos;attribution aux membres se fait dans l&apos;onglet «&nbsp;Membres&nbsp;».
        </p>
        <button
          onClick={() => setShowCreate(true)}
          className="shrink-0 flex items-center gap-2 px-4 py-2.5 bg-[#00236f] text-white text-sm font-semibold rounded-xl hover:bg-[#1e3a8a] transition-colors shadow-sm"
        >
