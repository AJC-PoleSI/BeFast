    ...
    <div className="p-8 h-full overflow-y-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-zinc-500 text-sm mt-1">Configurez les informations légales et administratives de votre Junior.</p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 pb-8">
        ...
        <div className="bg-white rounded-xl border border-zinc-200 overflow-hidden shadow-sm">
          <div className="bg-zinc-50 px-5 py-4 border-b border-zinc-100 flex items-center gap-3">
            ...
            <h2 className="font-bold text-zinc-800">Identité Légale</h2>
          </div>
          <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
            <div className="sm:col-span-2">
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">Raison Sociale</label>
              <input
                type="text"
                value={structureForm.raison_sociale}
                onChange={(e) => handleChange("raison_sociale", e.target.value)}
                className="w-full h-10 px-3 rounded-lg border border-zinc-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#00236f]/20 focus:border-[#00236f] transition-all"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">Numéro SIRET</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">Code APE</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">Numéro TVA</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">Numéro URSSAF</label>
              <input
                type="text"
        ...
        <div className="bg-white rounded-xl border border-zinc-200 overflow-hidden shadow-sm">
          <div className="bg-zinc-50 px-5 py-4 border-b border-zinc-100 flex items-center gap-3">
            ...
            <h2 className="font-bold text-zinc-800">Coordonnées</h2>
          </div>
          <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
            <div className="sm:col-span-2">
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">Adresse du Siège</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">Code Postal</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">Ville</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">Email de Contact</label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">Téléphone</label>
              <input
                type="tel"
        ...
        <div className="bg-white rounded-xl border border-zinc-200 overflow-hidden shadow-sm">
          <div className="bg-zinc-50 px-5 py-4 border-b border-zinc-100 flex items-center gap-3">
            ...
            <h2 className="font-bold text-zinc-800">Organigramme du Mandat (Signataires)</h2>
          </div>
        ...
        <div className="bg-white rounded-xl border border-zinc-200 overflow-hidden shadow-sm">
          <div className="bg-zinc-50 px-5 py-4 border-b border-zinc-100 flex items-center gap-3">
            ...
            <h2 className="font-bold text-zinc-800">Données Financières</h2>
          </div>
          <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
            <div className="sm:col-span-2">
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">IBAN</label>
              <input
                type="text"
                value={structureForm.iban}
                onChange={(e) => handleChange("iban", e.target.value)}
                className="w-full h-10 px-3 rounded-lg border border-zinc-200 bg-white text-sm font-mono focus:outline-none focus:ring-2 focus:ring-[#00236f]/20 transition-all"
              />
            </div>
            <div className="sm:col-span-2">
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">BIC</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">Frais de Dossier (€)</label>
              <div className="relative">
                <Receipt className="absolute left-3 top-2.5 h-5 w-5 text-zinc-400" />
                <input
                  type="number"
                  value={structureForm.frais_dossier}
                  onChange={(e) => handleChange("frais_dossier", e.target.value)}
                  className="w-full h-10 pl-10 pr-3 rounded-lg border border-zinc-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#00236f]/20 transition-all"
                />
              </div>
            </div>

            <div>
              <label className="block text-xs font-semibold text-zinc-600 mb-1.5 uppercase tracking-wide">TJH Moyen Visé (€)</label>
              <div className="relative">
                <Receipt className="absolute left-3 top-2.5 h-5 w-5 text-zinc-400" />
                <input
                  type="number"
